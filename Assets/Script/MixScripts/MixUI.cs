...
public class MixUI : MonoBehaviour {
    ...
    public Image productionItem; //목록에서 선택한 아이템
    public Text productionName; //그 이름

    public GameObject matIsOneAmount;
    public GameObject matIsTwoAmount; //재료2개
    public GameObject matISThreeAmount; //재료3개
