...
public class MixManager : MonoBehaviour
{
	...
	public GameObject listMould;
	//Resource ->Prefabs -> MixMaterialListMould 1

	//제작목록
	public Image[] mixList;
	//제작할 것들의 이미지를 넣을 목록

	//ShopList에 필요한 것들
	private GameObject mixContent;
	//awake
	private Transform contentStart;
	//awake
	private Transform contentEnd;
	//awake
	...
	public void DataSetting( int num, int id )
	{
		...
		{
			mixList[ num ].sprite = Resources.Load<Sprite>( "Image/UI/ItemIcon/none" );
