...
public class ShopManager : MonoBehaviour {
    ...
    //ShopList에 필요한 것들
    public GameObject shopContent; //awake
    public Transform contentStart; //awake
    public Transform contentEnd; //awake
    public float interval; //start
    public GameObject mould; //Resource ->Prefabs -> shopMould
